...
let tshirtProductViewModel = ProductViewModel(code: "TSHIRT", name: "T-shirt", price: 20.0, detail: "T-shirt detail", imageName: "tshirt", promotion: tshirtPromotion, quantity: 0)
...
let tshirtQuantityThreeProductViewModel = ProductViewModel(code: "TSHIRT", name: "T-shirt", price: 20.0, detail: "T-shirt detail", imageName: "tshirt", promotion: tshirtPromotion, quantity: 3)
